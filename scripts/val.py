...
def run(data,
    ...
    if training:  # called by train.py
        ...
        # Load model
        model = attempt_load(weights=weights[0], device=device)  # load FP32 model
        # print(model.detect.anchors)
        # raise NotImplementedError
        model.names = {0: 'person', 1: 'bicycle', 2: 'car', 3: 'motorcycle', 4: 'airplane', 5: 'bus', 6: 'train', 7: 'truck', 8: 'boat', 9: 'traffic light', 10: 'fire hydrant', 11: 'stop sign',
